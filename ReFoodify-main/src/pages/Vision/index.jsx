        ...
        <div className="vision-grid">
          ...
          <div className="vision-text-container">
            ...
            <p className="vision-description">
              ...
              ingredients into culinary possibilities. Our goal is to create a
              global community that shares recipes, reduces food waste, and
              supports local markets by buying near-expired products. Through
              innovation and collaboration, we aim to be a driving force in the
              fight against food waste, ensuring a healthier planet for future
              generations.
            </p>
          </div>
        </div>
