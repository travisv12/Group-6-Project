        ...
        <div className="relative isolate overflow-hidden bg-[#295143] px-6 sm:rounded-3xl sm:px-16 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
          ...
          <div className="mx-auto max-w-[90%] text-center lg:mx-0 lg:flex-auto pb-16 lg:text-left">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
              <a
                href="#"
                className="rounded-md bg-white px-3.5 py-2.5 text-lg font-semibold text-gray-900 shadow-sm hover:bg-gray-100 hover:scale-105 transition-transform duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                Claim your points 🎉
              </a>
              <a
